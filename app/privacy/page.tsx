...
export const metadata: Metadata = {
  title: "Privacy Policy - SmartReply",
  description:
    "How SmartReply handles Instagram account data, webhook payloads, billing data, and customer campaign information.",
};
...
export default function PrivacyPage() {
  return (
    <LegalShell
      ...
      description="SmartReply helps businesses send Meta-compliant private replies when people comment on connected Instagram posts or reels."
    ...
    >
      ...
      <section>
        ...
        <p className="mt-3">
          SmartReply does not ask for Instagram passwords, scrape Instagram, or
      ...
      <section>
        ...
        <p className="mt-3">
          ...
          the support email configured for the hosted SmartReply service.
        </p>
      </section>
    </LegalShell>
  );
