...
export const manychatAlternativePage: SeoPageConfig = {
  ...
  description:
    "SmartReply is for teams that do not need a broad chatbot builder. It turns keyword comments into Meta-compliant private replies, tracked links, campaign analytics, and client reports.",
  ...
  sections: [
    {
      ...
      body: "Broad automation suites can be powerful, but they also add flow-builder weight. SmartReply keeps the campaign path tight: keyword, post, reply, link, result.",
    },
    {
      title: "Agency proof",
  ...
  comparisonTitle: "SmartReply vs broad chatbot builders",
  comparisons: [
    {
      label: "Setup",
  ...
  faqs: [
    {
      title: "Is SmartReply a full Manychat replacement?",
      body: "No. SmartReply is intentionally focused on Instagram comment-to-DM campaigns. If you need a complete chatbot suite, use a broad platform. If you need fast campaign loops, SmartReply is built for that.",
    },
    {
...
export const agenciesSeoPage: SeoPageConfig = {
  ...
  description:
    "SmartReply gives agencies multi-account workspaces, client-ready reports, tracked links, and a focused comment-to-DM workflow for repeatable Instagram campaigns.",
...
export const commentLinkSeoPage: SeoPageConfig = {
  ...
  faqs: [
    ...
    {
      title: "Does SmartReply send a normal Instagram DM?",
